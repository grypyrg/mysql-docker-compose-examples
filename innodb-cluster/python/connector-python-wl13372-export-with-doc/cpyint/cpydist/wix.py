...
# Help function to be used by functions/methords below
def find_candle_bindir(wix_install_path):
    ...
    # directory, one "flat" with executables direcly in the install
    # directory
...
def check_wix_install(wix_install_path=WIX_INSTALL_PATH,
    ...
    if not m:
        raise DistutilsError("Can't parse version output from candle.exe: %s" %
                             (verline))
    ...
    if (wix_version[0] < wix_min_version[0] or 
        ...
        raise DistutilsError("Minimal WiX v%s, we found v%s" %
                             (".".join(wix_min_version), ".".join(wix_version)))

class WiX(object):
    """Class for creating a Windows Installer using WiX"""
    def __init__(self, wxs, out=None, msi_out=None,
                 base_path=None, install=WIX_INSTALL_PATH):
        """Constructor
    ...
    def compile(self, wxs=None, out=None, parameters=None):
        ...
        cmdargs = [
            ...
            wxs,
            r'cpyint\data\MSWindows\PY27.wxs',
            r'cpyint\data\MSWindows\PY34.wxs',
            r'cpyint\data\MSWindows\PY35.wxs',
            r'cpyint\data\MSWindows\PY36.wxs',
            r'cpyint\data\MSWindows\PY37.wxs',
            r'cpyint\data\MSWindows\PY38.wxs',
            r'cpyint\data\MSWindows\cpy_msi_gui.wxs',
        ]
        if parameters:
            params = dict(
    ...
    def link(self, wixobj=None, base_path=None, data_path=None):
        ...
        cmdargs = [
            ...
            r"{}\PY27.wixobj".format(data_path),
            r"{}\PY34.wixobj".format(data_path),
            r"{}\PY35.wixobj".format(data_path),
